...
function AppProvider({ children }) {
  const [mode, setMode] = useState('campus');   // 'campus' | 'country'
  ...
  const value = { mode, setMode, route, go, back, lang, setLang };
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
            ...
            <div>
              ...
              <div className="eyebrow" style={{ marginTop: 3, color: 'var(--muted)' }}>
                {mode === 'campus' ? 'Campus · DIU' : 'National · BD'}
              </div>
            </div>
          </div>
        )}
        ...
        <div style={{
          ...
          SA
          <span title="Verified DIU email" style={{
...
function RouteView() {
  ...
  const Comp = Map[route.name] || HomeScreen;
  return (
